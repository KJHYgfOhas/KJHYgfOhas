...
DATA_DIR="${1%/}"
SCRATCH_DIR="${DATA_DIR}/tfr-data/"
mkdir -p "${DATA_DIR}"
mkdir -p "${SCRATCH_DIR}"
WORK_DIR="${PWD}"

# Download the ImageNet data.
LABELS_FILE="${PWD}/imagenet_lsvrc_2015_synsets.txt"
...
BOUNDING_BOX_SCRIPT="${PWD}/process_bounding_boxes.py"
BOUNDING_BOX_FILE="${PWD}/imagenet_2012_bounding_boxes.csv"
