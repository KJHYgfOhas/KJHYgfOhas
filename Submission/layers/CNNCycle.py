import tensorflow
from tensorflow.keras.layers import Layer, Conv2D, Activation, Dropout, BatchNormalization
from tensorflow.keras.regularizers import l2

class CNNCycle(Layer):
    def __init__(self, output_shape, kernel_shape=(3,3), activation="relu", dropout_rate=0.0, kernel_regularizer=None, **kwargs):
        ...
        super(CNNCycle, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        ...
        super(CNNCycle, self).build(input_shape)  # Be sure to call this at the end
    ...
    def get_config(self):
        ...
        config = super(CNNCycle, self).get_config().copy()
        config.update({
